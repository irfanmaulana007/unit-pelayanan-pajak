	...
	<div class="row">
		<div class="col-12 m-t-20">
			<div class="box">
				...
				<h4 class="text-center">Master User</h4>
				<div class="row">
					<div class="col-12">
						<a href="{{ URL::to('user/create') }}"><button class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New User</button></a>
					</div>
				</div>
				<br>
					...
					<tbody>
						@foreach($user as $key => $value)
							<tr>
								...
								<td>
									<center>
										<a href="{{ URL::to('user/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i></a>
	        							<form action="{{ URL::to('user/' . $value->id) }}" method="POST">
										    {{ method_field('DELETE') }}
										    {{ csrf_field() }}
