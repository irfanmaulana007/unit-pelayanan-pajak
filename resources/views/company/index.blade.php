	...
	<div class="row">
		<div class="col-12 m-t-20">
			<div class="box">
				...
				<h4 class="text-center">Master Company</h4>
				<div class="row">
					<div class="col-12">
						<a href="{{ URL::to('company/create') }}"><button class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New Company</button></a>
					</div>
				</div>
				<br>
					...
					<tbody>
						@foreach($company as $key => $value)
							<tr>
								...
								<td>
									<center>
										<a href="{{ URL::to('company/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i></a>
