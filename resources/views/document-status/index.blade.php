	...
	<div class="row">
		<div class="col-12 m-t-20">
			<div class="box">
				...
				<h4 class="text-center">Master Document Status</h4>
				<div class="row">
					<div class="col-12">
						<a href="{{ URL::to('document-status/create') }}"><button class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New Document Status</button></a>
					</div>
				</div>
				<br>
					...
					<tbody>
						@foreach($documentStatus as $key => $value)
							<tr>
								...
								<td>
									<center>
										<a href="{{ URL::to('document-status/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i></a>
	        							<form action="{{ URL::to('document-status/' . $value->id) }}" method="POST">
										    {{ method_field('DELETE') }}
										    {{ csrf_field() }}
											    	...
											    	<div class="modal-content">
												    	<div class="modal-header">
											      		...
											      		<div class="modal-body text-center">
											        		Are you sure to delete this document status?
										        			<br><br>
										        			<center>
	...
	<script>
		...
		$(document).ready( function () {
		    ...
		    $(".fa-trash").click(function(){
		    	id = $(this).data('id');
		    	$("form").attr("action","/document-status/" + id)
		    });
		});
	</script>
@stop